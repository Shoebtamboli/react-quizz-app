  ...
  return createTheme({
    ...
    components: {
        ...
        styleOverrides: {
          root: {
            boxShadow: `4px 4px 8px rgba(0, 0, 0, ${
              darkMode ? 0.3 : 0.4
            }), -4px -4px 8px rgba(255, 255, 255, ${darkMode ? 0.07 : 0.6})`,
            borderRadius: "50%",
      ...
      MuiIconButton: {
        styleOverrides: {
          root: {
            ...
            boxShadow: `3px 3px 6px rgba(0, 0, 0, 0.25), -3px -3px 6px rgba(255, 255, 255, ${
              darkMode ? 0.06 : 0.3
            })`,
            padding: 8,
            "&:hover": {
      ...
      MuiFab: {
        styleOverrides: {
          root: {
            boxShadow: `6px 6px 12px rgba(0, 0, 0, ${
              darkMode ? 0.25 : 0.4
            }), -6px -6px 12px rgba(255, 255, 255, ${darkMode ? 0.1 : 0.7})`,
            "&:active": {
              boxShadow: `inset 6px 6px 12px rgba(0, 0, 0, 0.5), inset -6px -6px 12px rgba(180, 180, 180, 0.4)`
            }
          },
      ...
      MuiButton: {
        styleOverrides: {
          contained: {
            ...
            boxShadow: `5px 5px 10px rgba(0, 0, 0, ${
              darkMode ? 0.2 : 0.4
            }), -5px -5px 10px rgba(255, 255, 255, ${darkMode ? 0.1 : 0.7})`,
            "&:hover": {
              background: `linear-gradient(145deg, ${shadeHexColor(
                primary,
                -0.15
        ...
        styleOverrides: {
          rounded: {
            background: `linear-gradient(145deg, ${shadeHexColor(
              background,
              darkMode ? 0.1 : 0.1
            )}, ${shadeHexColor(background, darkMode ? 0 : 0.2)})`,
            borderRadius: "20px"
          },
          elevation1: {
            background: shadeHexColor(background, darkMode ? 0.05 : 0.2),
            boxShadow: `3px 3px 6px rgba(0, 0, 0, 0.2), -2px -2px 4px rgba(255, 255, 255, ${
              darkMode ? 0.05 : 0.3
            })`,
            borderRadius: "10px"
          },
      ...
      MuiCssBaseline: {
        styleOverrides: {
          "@global": {
            body: {
              background: darkMode
                ? `linear-gradient(145deg, ${background}, ${shadeHexColor(
                    background,
                    -0.57
                  )})`
                : `linear-gradient(145deg, ${background}, ${shadeHexColor(
